...
labelsPath = os.path.sep.join([os.path.dirname(os.path.abspath(_file_)), "yolo-coco", "coco.names"])
LABELS = open(labelsPath).read().strip().split("\n")

# derive the paths to the YOLO weights and model configuration
weightsPath = os.path.sep.join([os.path.dirname(os.path.abspath(_file_)), "yolo-coco", "yolov3.weights"])
configPath = os.path.sep.join([os.path.dirname(os.path.abspath(_file_)), "yolo-coco", "yolov3.cfg"])
...
def detectfinal(iter):
    ...
    for i in range(2):
        imglist.append(
            os.path.sep.join([os.path.dirname(os.path.abspath(_file_)), "frames", f'{i + 1}', f'{iter}' + '.jpg']))
        imglist.append(
            os.path.sep.join(
                [os.path.dirname(os.path.abspath(_file_)), "frames", f'{i + 3}', f'{iter + 350}' + '.jpg']))
...
print(detectfinal(1))
# getFrameHelper(os.path.sep.join([os.path.dirname(os.path.abspath(_file_)), "videos_raw", "3.mp4"]))
